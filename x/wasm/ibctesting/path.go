...
func NewPath(chainA, chainB *TestChain) *Path {
	/*
		endpointA := NewEndpoint(chainA, ibctesting.NewTendermintConfig(), ibctesting.NewConnectionConfig(), &ibctesting.ChannelConfig{
			PortID:  "transfer",
			Version: "ics20-1",
			Order:   channeltypes.UNORDERED,
		})
		endpointB := NewEndpoint(chainB, ibctesting.NewTendermintConfig(), ibctesting.NewConnectionConfig(), &ibctesting.ChannelConfig{
			PortID:  "transfer",
			Version: "ics20-1",
			Order:   channeltypes.UNORDERED,
		})
